...
function insert_tag($name, $description, $syntax, $example, $remarks)
{
	...
	print("<tr valign=top><td width=25%>".T_("DESCRIPTION").":</td><td>$description\n");
	print("<tr valign=top><td>".T_("SYNTAX").":</td><td><tt>$syntax</tt>\n");
	print("<tr valign=top><td>".T_("EXAMPLE").":</td><td><tt>$example</tt>\n");
	print("<tr valign=top><td>".T_("RESULT").":</td><td>$result\n");
	if ($remarks != "")
		print("<tr><td>".T_("REMARKS").":</td><td>$remarks\n");
	print("</table>\n");
}
