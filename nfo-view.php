...
if ($res["nfo"] != "yes")
  show_error_msg("Not Found", "This torrent does not have a NFO", 1);
...
if($res["nfo"] == "yes"){
    ...
    if ($nfo) {
		...
		if($CURUSER["edit_torrents"]=="yes")
            begin_frame(T_("NFO_FILE_FOR").": <a href=".$site_config["SITEURL"]."/torrents-details.php?id=$id>$shortname</a> - <a href=nfo-edit.php?id=$id>[Edit NFO]</a>");
        else
            begin_frame(T_("NFO_FILE_FOR").": $shortname<a name=nfo></a>");
